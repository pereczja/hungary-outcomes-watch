...
const EUROSTAT_URL =
  'https://ec.europa.eu/eurostat/api/dissemination/statistics/1.0/data/nama_10_pc?format=JSON&time=2010-2024&geo=HU&geo=PL&geo=SK&geo=RO&unit=CP_EUR_HAB&na_item=B1GQ';
    ...
    <Card className="bg-gradient-surface">
      <CardContent className="p-4">
        <div className="mb-3 flex items-start justify-between gap-4">
          ...
          <a className="story-link text-xs" target="_blank" rel="noreferrer" href="https://ec.europa.eu/eurostat/api/dissemination/statistics/1.0/data/nama_10_pc?time=2010-2024&geo=HU&geo=PL&geo=SK&geo=RO&unit=CP_EUR_HAB&na_item=B1GQ&format=JSON">Live source</a>
        </div>
        {error && (
